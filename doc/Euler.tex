...
\lstinputlisting[caption=Problem 1: Na\"ive Solution,label=L:1:naive.c,float=htp]{../lang/C/1-1.c}
		...
		\section{Direct Computation}
			...
			\lstinputlisting[caption=Problem 1: C Solution,label=L:1:1.c,float=htp]{../lang/C/1-2.c}
	...
	\chapter{Sum of Even Fibonacci Numbers}
		...
		\section{Introduction}
			...
			\lstinputlisting[caption=Problem 2: Na\"ive Solution,label=L:2:naive.c,float=htp]{../lang/C/2-1.c}
		...
		\section{Computing \texttt{fib(n)} Directly}
			...
			\end{alignat}
			\lstinputlisting[caption=Problem 2: \texttt{fib(n)} Direct,label=L:2:1.c,float=htp]{../lang/C/2-2.c}
	...
	\section{Direct Computation}
		...
		\lstinputlisting[caption=Problem 2: Direct Solution,label=L:2:2.c,float=htp]{../lang/C/2-3.c}

	\section{Generalization}
	
		We generalize the above solution to arbitrary $n$ within the limits of \texttt{unsigned long long} in Listing \ref{L:2:3.c}. 
		
		\lstinputlisting[caption=Problem 2: General Solution,label=L:2:3.c,float=htp]{../lang/C/2-4.c}
	...
	\chapter{Largest Prime Factor of $n$}
		...
		\section{Introduction}
			...
			\lstinputlisting[caption=Problem 3: Na\"ive Solution,label=L:3:naive.c,float=htp]{../lang/C/3-1.c}
	...
	\chapter{Largest Palindrome Product}
		...
		\section{Introduction}
			...
			This problem presents a few programming issues, the first is to factor an integer and find products of the factors of a given decimal size. The other is to iterate the palindrome numbers\footnote{absent any theory which short circuits these requirements.}. The numbers which result from three digit multiplication range from $10000=100\times 100$ to $998001=999\times 999$; thus we must consider representations of palindrome numbers which have an even and odd number of digits. 
