...
01 70 54 71 83 51 54 69 16 92 33 48 61 43 52 01 89 19 67 48 \\
	...
	\chapter{Maximum Path Sum I}
		...
		\section{Solving the Triangle}
			...
			On row $1$ and entry $0$ we compute the sum of the previous distance ($0$) and the edge ($3$). Likewise for row $1$ and entry $1$. 
			...
			On row $2$ the first entry must be $3+7=10$, the last entry must be $3+4=7$. 
			\begin{alignat}{4}
				\begin{array}{ccccccc}
					&&&{3}&&& \\
					&&{7}&& 4&& \\
				...
				\end{array}
			\end{alignat}
			For the first (middle) element we have a choice. We may pass through $7$ or $4$. Since each node above it has a distance of $3$ we choose $3+7=10$ over $3+4=7$ (recall, we are looking for the largest/longest path). 
			\begin{alignat}{4}
				\begin{array}{ccccccc}
					&&&{3}&&& \\
					&&{7}&& 4&& \\
			...
			On row $3$ we fix the end points as before
