	...
	\chapter{Largest Palindrome Product}
		...
		\section{Palindrome Numbers}
			...
			\subsection{Predecessor and Successor}	
				...
				From this we can compute the predecessor function $(a,b)--$, remembering to take care of a  few extra special cases. 
				\begin{alignat}{4}
					(a,b)--=\left\{\begin{array}{ll}
						\mathtt{UNDEFINED},&a=0\Land b=\mathtt{ODD} \\
						(a-1, b),&a\neq 10^k,k\in\mathbb{N},k>0 \\
						\left(a-1, \mathtt{EVEN}\right),&a=10^k,k\in\mathbb{N},k>0\Land b=\mathtt{ODD} \\
						\left(\left(a-1\right)\cdot 10+9, \mathtt{ODD}\right),&a=10^k,k\in\mathbb{N},k>0\Land b=\mathtt{EVEN}
					\end{array}\right.
				\end{alignat}
...
\appendix
	\chapter{Factoring}\label{C:Factoring}
		\section{Introduction}
		...
		\lstinputlisting[caption=\texttt{factor.c},label=L:factor:factor.c,float=htp]{../src/lang/C/factor.c}
